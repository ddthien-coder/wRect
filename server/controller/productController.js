...
const createProductReview = asyncHandler(async (req, res) => {
	...
	if (product) {
		...
		if (alreadyReviewed) {
			res.status(404).send('Product already reviewed.');
...
export {getProduct, deleteProduct, createProductReview, updateProduct, createNewProduct, removeProductReview, getProducts}